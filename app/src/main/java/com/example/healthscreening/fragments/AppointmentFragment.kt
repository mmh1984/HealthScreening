...
import com.example.healthscreening.booking.booking1
  ...
  lateinit var sw:SwipeRefreshLayout
    ...
    override fun onCreateView(
        ...
        btnbook.setOnClickListener{
            var i= Intent(activity,booking1::class.java)
            startActivity(i)
        }
    ...
    fun jsonfetch(){
        ...
        var url=ip.address +"clinic/controls/appointments.php?op=clientapp&id=" + sp.getString("patientid","")
